...
level.prototype.obstacleAt = function (pos, size) {
  ...
  //consider the sides and top and bottom of hte level as walls
  if (xStart < 0 || xEnd > this.width || yStart < 0 || y End > this.height)
      return "wall";
...
//code for when player dies in lava you go back ti starting point
  if (obstacle == "lava")
  {
